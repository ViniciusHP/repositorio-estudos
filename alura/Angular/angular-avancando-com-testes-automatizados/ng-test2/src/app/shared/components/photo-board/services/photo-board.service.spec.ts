...
describe(PhotoBoardService.name, () => {
  ...
  SHOULD return photos with description in uppercase`, (done) => {
    ...
    // A configuração deve ficar depois do subscribe
    // pois a requisição deve ser feita primeiro para só depois configurar qual a resposta para ela
    // até lá, a requisição estará parada
    httpController
