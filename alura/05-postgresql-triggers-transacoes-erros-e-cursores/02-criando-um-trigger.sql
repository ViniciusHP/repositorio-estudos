...
CREATE OR REPLACE FUNCTION cria_instrutor() RETURNS TRIGGER AS $$
    ...
    RETURN NEW; -- Como a função será executada depois do INSERT, nós devemos retornar algo
    -- E normalmente pode ser o próprio registro, mas nesse caso de executar após algo, retornar NULL não teria problema
	END;
$$ LANGUAGE PLPGSQL;
...
INSERT INTO instrutor (nome, salario) VALUES ('Outra pessoa', 700);
